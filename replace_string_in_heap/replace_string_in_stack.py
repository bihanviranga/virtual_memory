...
in the stack of a process.

Usage:
	./replace_string_in_stack.py PID search_string replace_string
...
for line in maps_file:
	...
	# get base and limit of the stack in virtual memory
	addr = addr.split("-")
	...
	# there is only one stack, so end
	break
